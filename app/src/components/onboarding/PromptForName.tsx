...
interface PromptForNameProps {
  onCompleted: (first_name: string, last_name: string) => void;
}

interface PromptForNameState {
  first_name: string;
  last_name: string;
}

class PromptForName extends Component<PromptForNameProps, PromptForNameState> {
  constructor(props: PromptForNameProps) {
    super(props);
    this.state = {
      first_name: "",
      last_name: "",
